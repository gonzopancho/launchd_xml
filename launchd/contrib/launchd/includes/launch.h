...
#ifdef _SQL_CONF_
#define PID1LAUNCHDSB_CONF  "/etc/launchd_sb.conf"
#define LAUNCHDSB_CONF      ".launchd_sb.conf"
#endif

#ifndef LAUNCHCTL_PLIST_PATH
#define LAUNCHCTL_PLIST_PATH "/sbin/launchctl"
#endif

#ifdef _SQL_CONF_
#ifndef LAUNCHCTL_SQL_PATH
#define LAUNCHCTL_SQL_PATH "/sbin/launchctl"
#endif
#endif
...
void            launch_data_dict_dump(launch_data_t);
void            launch_data_array_dump(launch_data_t);
void            launch_data_dump(launch_data_t);
